...
//                 <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-800 group-hover:opacity-0 transition-opacity duration-300"></div>
...
//       {/* Testimonial Section */}
//       <section className="py-20 bg-gradient-to-br from-black to-blue-900/20 relative overflow-hidden">
...
//             <button className="absolute left-0 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-white transition-colors hover:bg-blue-500/10 rounded-full">
//               <ChevronLeft className="w-8 h-8" />
//             </button>
//             <div className="text-center px-12">
//               <p className="text-2xl md:text-4xl font-serif leading-relaxed mb-8">
//                 "Over the years, I've acquired a gratifying number of readers
//                 and followers, with more arriving each day, and I owe much of
//                 that audience to the tools and opportunities that our platform
//                 provides."
//               </p>
//               <div className="text-blue-400 font-medium">Alec N.</div>
//             </div>
//             <button className="absolute right-0 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-white transition-colors hover:bg-blue-500/10 rounded-full">
...
//               © 2025 BloggingPlatform. All rights reserved.
//             </div>
//             <nav>
